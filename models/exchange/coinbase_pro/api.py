...
class AuthAPI(AuthAPIBase):
    ...
    def getProducts(self) -> pd.DataFrame:
        """Retrieves your list of markets"""

        # GET /api/v3/account
        try:
            df = self.authAPI("GET", "products")
        except:
            return pd.DataFrame()
    ...
    def getProduct(self, product: str) -> pd.DataFrame:
        ...
        try:
            return self.authAPI("GET", f"products/{product}")
        except:
            return pd.DataFrame()
